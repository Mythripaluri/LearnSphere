        ...
        <div className="flex flex-col gap-y-6  mt-5">
          <div className="flex justify-between">
            ...
            <Link to="/dashboard/my-courses">
              <p className="text-xs font-semibold text-teal-50 hover:underline pr-5">View All</p>
            </Link>
          </div>
        ...
        courses.length > 0 ? (
          <div>
            ...
            <div className="rounded-md bg-richblack-800 p-6">
              <div className="flex items-center justify-between">
                ...
                <Link to="/dashboard/my-courses">
                  <p className="text-xs font-semibold text-teal-50 hover:underline">View All</p>
                </Link>
              </div>
          ...
          <div className="mt-20 rounded-md bg-richblack-800 p-6 py-20">
            ...
            <Link to="/dashboard/add-course">
              <p className="mt-1 text-center text-lg font-semibold text-teal-50">
                Create a course
              </p>
            </Link>
          </div>
