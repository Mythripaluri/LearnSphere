                  ...
                  <Td className="flex flex-1 gap-x-4 relative">
                    ...
                    <div className="flex flex-col">
                      ...
                      {course.status === COURSE_STATUS.DRAFT ? (
                        ...
                        :
                        (<div className="mt-2 flex w-fit flex-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-[2px] text-[12px] font-medium text-teal-100">
                          <p className="flex h-3 w-3 items-center justify-center rounded-full bg-teal-100 text-richblack-700">
                            <FaCheck size={8} />
                          </p>
                          Published
                        </div>
